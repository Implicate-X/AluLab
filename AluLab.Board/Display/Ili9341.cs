...
namespace AluLab.Board.Display
{
	...
	public partial class Ili9341 : GraphicDisplay
	{
		...
		internal const int SX = 240;
		internal const int SY = 320;
		...
		/// <summary> Values that represent display rotation types. </summary>
		...
		public Ili9341( 
			...
			int resetPin, 
			int backlightPin = -1, 
			int spiBufferSize = DefaultSPIBufferSize,
			GpioController? gpioController = null,
			Orientation orientation = Orientation.LandscapeFlipped,
