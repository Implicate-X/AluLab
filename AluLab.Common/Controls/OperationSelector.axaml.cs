...
public partial class OperationSelector : UserControl
{
	...
	{
		"Arith(CN=L) 0000  A⊟1̅ ",
		"Arith(CN=L) 0001  A∧B⊟1̅ ",
		"Arith(CN=L) 0010  A∧~(B)⊟1̅ ",
		"Arith(CN=L) 0011  1̅ ",
		"Arith(CN=L) 0100  A⊞(A∨~(B))",
		"Arith(CN=L) 0101  A∧B⊞(A∨~(B))",
		"Arith(CN=L) 0110  A⊟B⊟1̅ ",
		"Arith(CN=L) 0111  A∨~(B)",
		"Arith(CN=L) 1000  A⊞(A∨B)",
		"Arith(CN=L) 1001  A⊞B",
		"Arith(CN=L) 1010  A∧~(B)⊞(A∨B)",
		"Arith(CN=L) 1011  (A∨B)",
		"Arith(CN=L) 1100  A⊞A",
		"Arith(CN=L) 1101  A~(B)⊞A",
		"Arith(CN=L) 1110  AB⊞A",
		"Arith(CN=L) 1111  A"
	};
